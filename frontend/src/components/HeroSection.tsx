      ...
      <div className="relative z-20 flex flex-col lg:flex-row items-center justify-between px-6 sm:px-12 lg:px-20 py-10 sm:py-12 lg:py-0 min-h-screen">
        ...
        <div className="flex-1 max-w-3xl text-white lg:pr-12">
          ...
          <p className="mt-6 text-xl text-blue-100 drop-shadow-md leading-relaxed max-w-2xl">
            ...
            , we provide a complete range of digital, design, and development
            services tailored to your unique business needs in Nepal and beyond.
          </p>
          ...
          <div className="mt-10 flex flex-wrap gap-4 items-center">
            <button
              ...
              className="px-8 py-4 rounded-md bg-white text-blue-900 font-semibold shadow-xl hover:bg-blue-50 hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center gap-3 focus:outline-none focus:ring-4 focus:ring-white/30 active:scale-95"
            >
            ...
            <Link
              to="/services"
              className="px-8 py-4 rounded-md border-2 border-white/80 text-white font-semibold bg-white/10 backdrop-blur-sm hover:bg-white hover:text-blue-900 hover:scale-105 transition-all duration-300 flex items-center gap-3 focus:outline-none focus:ring-4 focus:ring-white/30 active:scale-95 group"
            >
              Our Services
